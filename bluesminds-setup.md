...
**Статус (2026-06-14):** ВОССТАНОВЛЕН — конфиг подтянут из `configs/` memory-репо. Не нужно пересоздавать.
**⚠️ (2026-06-19):** configs/ УДАЛЁН из sync-репо. Recovery через configs/ больше не работает — настраивать вручную на новом устройстве.
