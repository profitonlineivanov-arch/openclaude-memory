...
**Пороги (анализ 2026-05-31):**
- play_threshold=0.47 из config_v5.yaml — подтверждён симуляцией: медиана распределения hit_rate
- Распределение: 0.30(2), 0.35(12), 0.40(34), 0.45(36), 0.50(49), 0.55(19), 0.60(14), 0.65(1) из 167 hour+dow combos
- При 0.47: PLAY acc=51.7%, 68 сигналов/день (71% тиражей)
- При 0.50: PLAY acc=53.4%, 47 сигналов/день (49%)
- При 0.52: PLAY acc=55.8%, 25 сигналов/день (26%)
- Границы корректировки feedback (0.40–0.55) заданы вручную
